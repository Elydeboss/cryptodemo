          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="flex items-center space-x-4 ml-8">
                <Button variant="outline" className="border-gray-600 text-black-600 hover:bg-gray-700">
                  Login
                </Button>
            ...
            <div className="md:hidden bg-gray-800 border-t border-gray-700">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <div className="pt-4 space-y-2">
                  <Button variant="outline" className="w-full border-gray-600 text-black-600 hover:bg-gray-700">
                    Login
                  </Button>
          ...
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <Button
                variant="outline"
                size="sm"
                className="border-gray-600 text-black-600 hover:bg-gray-700"
              >
